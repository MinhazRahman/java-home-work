...
public class ArrayOperation {
    ...
    public static void main(String[] args){
        ...
        System.out.println("1). Length of the array: " + lengthOfArray);

        System.out.println("2). Name written on 3rd position: " + aName);

        System.out.println("3). Name of each friend/colleague: ");
        for (String name: names) {

            System.out.println(name);
        }

        System.out.println("4). Does name on 2nd position, start with \"A\": " + isFirstCharacterA);
